        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="images/{{$room->image}}" alt="Image" class="img-fluid"></a>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-5 ml-auto">
            ...
            <p class="mb-4">Khách sạn Green Hotel luôn mang vẻ đẹp hiện đại xen lẫn nét cổ kính. Đặt khách sạn sớm nhất để hưởng trọn ưu đãi, hứa hẹn một kì nghỉ với những ...</p>
      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-6 col-lg-3">
            <a href="images/{{$availableRoom->image}}" class="image-popup img-opacity"><img src="images/{{$availableRoom->image}}" alt="Image" class="img-fluid"></a>
          </div>
          @endforeach
        </div>
      </div>
          ...
          <div class="media-with-text p-md-5">
            <div class="img-border-sm mb-4">
              <a href="#" class="popup-vimeo image-play">
                <img src="images/{{$room->image}}" alt="" class="img-fluid">
              </a>
            </div>
